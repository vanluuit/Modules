...
<div class="row">
    <div class="col-sm-12">
        <h2>{{$ads->title}}</h2>
        <ul class="sub_menu">
            <li><a href="{{ route('admin.ads') }}">一覧</a></li>
            <li><a href="{{ route('admin.editads',['id'=>$ads->id]) }}">編集</a></li>
        </ul>
        <table class="tb">
            <caption>入札</caption>
            <tbody>
        ...
        <table class="tb">
            ...
            <tbody>
                <tr>
                    <th style="width:220px;">掲載許可</th>
                    <td class="">
                        {{config('siteconfig.permission_ads')[$ads->permission]}}
                    </td>
                </tr>
            </tbody>
        </table>
