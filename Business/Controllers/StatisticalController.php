...
class StatisticalController extends Controller
{
	public function MonthOwnerCount(Request $request) {
        ...
        }])->where('user_id',$user_id)->has('statistical')->get();

        return view('Business::statistical.monthownercount', compact('xAxis', 'yAxis','arcl','total_price','total_click','ads_mounths'));
	}
    ...
    public function YearOwnerCount(Request $request) {
        ...
        return view('Business::statistical.yearownercount', compact('datas','num','y','m'));
    }
    ...
    public function AdsStatistical(Request $request) {
        ...
        return view('Business::statistical.adsstatistical', compact('data','ads'));
    }
}
